...
export declare const QueueNames: {
    ...
    readonly styleProfileRecompute: "style_profile_recompute";
    readonly conversationIndexing: "conversation_indexing";
    readonly syntheticConversationGen: "synthetic_conversation_gen";
...
export declare const styleProfileRecomputeQueue: Queue<any, any, string, any, any, string>;
export declare const conversationIndexingQueue: Queue<any, any, string, any, any, string>;
export declare const syntheticConversationGenQueue: Queue<any, any, string, any, any, string>;
