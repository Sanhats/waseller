...
export type ConversationStageV1 =
  | "waiting_product"
  | "waiting_variant"
  | "variant_offered"
...
export type ConversationNextActionV1 =
  | "reply_only"
  | "ask_clarification"
  | "confirm_variant"
  | "offer_reservation"
...
export const buildStableDedupeKey = (...parts: Array<string | undefined | null>): string => {
...
export const buildCorrelationId = (): string => randomUUID();
