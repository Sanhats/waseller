...
exports.leadWorker = new bullmq_1.Worker(src_1.QueueNames.leadProcessing, async (job) => {
    ...
    let message = job.data.llmDecision?.draftReply ??
    ...
    const shouldKeepLlmReply = Boolean(job.data.llmDecision?.draftReply) && llmConfidence >= PLAYBOOK_OVERRIDE_CONFIDENCE_MAX;
